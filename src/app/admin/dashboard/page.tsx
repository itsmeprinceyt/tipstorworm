    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                ...
                setRecentActivity([
                    { action: "user_signup", description: "New user registered", time: "2 mins ago" },
                    { action: "post_create", description: "New post created", time: "5 mins ago" },
                    { action: "content_report", description: "Content report submitted", time: "12 mins ago" },
                    { action: "invite_token_create", description: "New invite token generated", time: "1 hour ago" },
                ]);
                    ...
                    >
                        <div className="bg-black/40 backdrop-blur-sm border border-stone-800 rounded-xl p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h2 className="text-2xl font-bold text-white mb-2">Pending Suggestions</h2>
