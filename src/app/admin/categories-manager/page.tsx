          ...
          {selectedCategory && (
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
              <motion.div
                ...
                className="bg-gradient-to-br from-gray-900 to-black border border-gray-700 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl"
              >
                {/* Header */}
                <div className="p-6 border-b border-gray-700 flex justify-between items-center bg-gradient-to-r from-blue-900/20 to-purple-900/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Complete information about the category
                      </p>
                    </div>
                  </div>
                  <motion.button
                        ...
                        <div className="divide-y divide-gray-700">
                          ...
                          <div className="p-4 flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-white">
                                @{selectedCategory.created_by.username || "N/A"}
                              </div>
                            </div>
                          </div>
                ...
                <div className="bg-gray-800/50 border-t border-gray-700 p-4 flex justify-end">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={() => setSelectedCategory(null)}
                    className="px-6 py-2 rounded-xl bg-gray-700 text-white font-medium hover:bg-gray-600 transition-all duration-300 flex items-center gap-2"
                  >
                    <X className="w-4 h-4" />
                    Close Details
                  </motion.button>
