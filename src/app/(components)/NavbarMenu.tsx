                ...
                <div className="pt-2 border-t border-stone-800">
                    {session ? (
                        <motion.button
                            ...
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                            className="w-full p-3 rounded-lg text-white/80 hover:text-white hover:bg-stone-800/30 transition-all duration-300 disabled:opacity-50 flex items-center justify-center space-x-2"
                        >
                            {isLoggingOut ? (
                                <>
                        ...
                        >
                            <Link
                                href="/login"
                                onClick={onClose}
                                className="block p-3 rounded-lg text-white/80 hover:text-white hover:bg-stone-800/30 transition-all duration-300 text-center"
                            >
                                Login
                            </Link>
                        </motion.div>
