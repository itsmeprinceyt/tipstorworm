...
export const dbName = isProduction ? process.env.PROD_DB_NAME! : process.env.LOCAL_DB_NAME!;
const dbHost = isProduction ? process.env.PROD_DB_HOST! : process.env.LOCAL_DB_HOST!;
